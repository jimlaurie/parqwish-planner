  ...
  return (
    <div style={{ paddingBottom: "48px" }}>
      ...
      >
        ...
        <p style={{ margin: 0, fontSize: "var(--text-sm)", color: "var(--color-text-secondary)", lineHeight: "var(--leading-relaxed)" }}>
          Sign in — with Apple, Google, an email link, or just &ldquo;continue without an account&rdquo; — to turn on <strong style={{ color: "var(--color-text-primary)" }}>Cloud Sync</strong> from the Play page. Your wish catalog, day plan, and (for shared trips) collaborators&apos; changes stay in sync automatically and end-to-end encrypted, no file transfer needed.
          <strong style={{ color: "var(--color-text-primary)" }}> It&apos;s free</strong> — no subscription required on either platform, on top of file-based transfer which always works without an account.
