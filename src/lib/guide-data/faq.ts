...
export const FAQ_SECTIONS: FaqSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "If you export regularly via the Sync screen, you have a backup file on whatever device you exported to (desktop, cloud drive, email). Without an export, data on the phone only exists on that device. We recommend doing an export at the end of each day so your progress is always safely backed up to your desktop.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer:
          "ParQwish uses file-based sync — no Wi-Fi pairing or account required. You export a JSON file from one device and import it on another. The most common method is AirDrop (iPhone to Mac is instant), but email, iCloud Drive, or any file-sharing app works just as well. A 6-digit verification code prevents importing the wrong file by accident.",
      },
      {
        question: "What's the difference between Merge and Replace when importing?",
        answer:
          "Merge adds imported items alongside your existing data, skipping anything that already exists (matched by ID). Use Merge when you're combining data from multiple people or doing a mid-trip update. Replace clears the existing data for the selected categories before importing. Use Replace only for a clean first import or when you want the imported file to be the definitive record.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Yes. Export from Phone A and AirDrop or share the file directly to Phone B, then import on Phone B. The mobile app's Sync screen handles both export and import. The file can also be stored in iCloud Drive and imported from there.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "VIP removes the per-day item limits on the mobile app, giving you unlimited rides, shows, dining entries, outfits, and shopping items per day. It also unlocks Sync export and import on mobile. The web planner remains fully free regardless of subscription status.",
      },
      {
        question: "What happens to my data if my subscription lapses?",
        answer:
          "Your data is never deleted. If your subscription lapses, the mobile app enters read-only mode — you can view your existing data and GPS trail but can't add new items or export via Sync until you resubscribe. All your data remains on the device and becomes fully accessible again when you renew.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer:
          "The PDF map only shows GPS trail data that has been imported into the PWA via a Sync file. If you haven't exported from your phone and imported into the PWA, the trail data isn't available to the PDF generator. Do a final Sync export from your phone, import it in PWA › Play, then regenerate the PDF.",
      },
      {
